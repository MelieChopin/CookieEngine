...
ParticlesShader::ParticlesShader(std::string _name) :
    Shader(_name)
{
    ID3DBlob* VS;
...
std::string ParticlesShader::GetVertexSource()
{
...
std::string ParticlesShader::GetPixelSource()
{
    return (const char*)R"(
...
bool ParticlesShader::CompileVertex(ID3DBlob** VS)
{
    ID3DBlob* VSErr;
...
bool ParticlesShader::CompilePixel()
{
    ID3DBlob* PS;
    ID3DBlob* PSErr;
...
bool ParticlesShader::CreateLayout(ID3DBlob** VS)
{
    struct Vertex
    {
...
bool ParticlesShader::CreateBuffer()
{
...
bool ParticlesShader::CreateSampler()
{
...
void ParticlesShader::Set(const Core::Math::Mat4& viewProj, const Core::Math::Mat4& model)
{
